...
import type { bannerEditFormSchema } from "@qco/validators";
...
type BannerFormData = z.infer<typeof bannerEditFormSchema>;
...
export function BannerVisuals({
  ...
  const { setValue, watch } = useFormContext<BannerFormData>();
